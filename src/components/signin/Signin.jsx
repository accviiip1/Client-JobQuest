...
import logo from "../../assets/images/logoSDU-JobQuest.png";
import "./signin.scss";
...
export default function Signin() {
  const { loginUser, loginUserWithGoogle, currentUser } = useAuth();
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      ...
      await loginUserWithGoogle(credentialResponse.credential);
      setLoading(false);
    } catch (error) {
      console.error('Google login error:', error);
      setErr(error?.response?.data?.message || error?.response?.data || "Đăng nhập Google thất bại!");
    }
    setLoading(false);
  };
  ...
  }, []); // Remove inputs dependency to prevent infinite re-renders
