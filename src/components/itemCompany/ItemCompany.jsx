          ...
          <div className="itemCompany__wrapper__body">
            <div className="itemCompany__wrapper__body__right">
              ...
              <div className="desc">
                ...
                <div className="stats">
                  <span className="job">{company?.job_count ? (company.job_count > 99 ? "+99" : company.job_count) : 0} việc làm</span>
                  <span className="followers">{company?.follower_count ? (company.follower_count > 99 ? "+99" : company.follower_count) : 0} theo dõi</span>
                </div>
              </div>
            </div>
