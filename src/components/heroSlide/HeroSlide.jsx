      ...
      <div className="container">
        <div className="HeroSlide__wrapper row">
          <div className="HeroSlide__wrapper__left col pc-7 t-7 m-12">
            <h4>
              "Khám phá tiềm năng nghề nghiệp cùng SDU-JobQuest - Bước đầu cho sự nghiệp tươi sáng!"
            </h4>
            <span>
              Hãy bắt đầu cuộc hành trình tìm kiếm công việc mơ ước của bạn ngay hôm nay tại
              SDU-JobQuest - nền tảng đáng tin cậy dành riêng cho cộng đồng người Việt Nam. Với hàng
